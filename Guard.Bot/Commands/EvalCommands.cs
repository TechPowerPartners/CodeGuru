...
internal class EvalCommands : BaseCommandModule
{
    ...
    public EvalCommands()
    {
        _serializerOptions.MaxDepth = 10240;
        _serializerOptions.IncludeFields = true;
        _serializerOptions.PropertyNameCaseInsensitive = true;
        _serializerOptions.ReferenceHandler = ReferenceHandler.IgnoreCycles;
        _serializerOptions.NumberHandling |= JsonNumberHandling.AllowNamedFloatingPointLiterals;
        _serializerOptions.Converters.Add(new TypeJsonConverter());
        _serializerOptions.Converters.Add(new TypeInfoJsonConverter());
        _serializerOptions.Converters.Add(new RuntimeTypeHandleJsonConverter());
        _serializerOptions.Converters.Add(new TypeJsonConverterFactory());
        _serializerOptions.Converters.Add(new AssemblyJsonConverter());
        _serializerOptions.Converters.Add(new ModuleJsonConverter());
        _serializerOptions.Converters.Add(new AssemblyJsonConverterFactory());
        _serializerOptions.Converters.Add(new DirectoryInfoJsonConverter());
        _serializerOptions.Converters.Add(new IntPtrJsonConverter());
    }
    ...
    public async Task ProcessEvalCommand(CommandContext context, [RemainingText] string input)
    {
        try
        {
            var result = await ExecuteCode(input, _serializerOptions);

            var json = JsonSerializer.Serialize(value: result.ReturnValue, _serializerOptions);
    ...
    private async Task<EvalResult> ExecuteCode(string code, JsonSerializerOptions serializerOptions)
    {
        ...
        try
        {
            JsonSerializer.Serialize(value: evalResult, options: serializerOptions);
        }
        catch (Exception ex)
        {
