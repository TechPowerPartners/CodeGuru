...
import { TuiDataListModule, TuiDialogModule, TuiDropdownModule, TuiHostedDropdownModule, TuiNotificationModule, TuiRootModule, TuiSvgModule } from '@taiga-ui/core';
...
@Component({
  ...
  standalone: true,
  imports: [
    TuiTabsModule,TuiHostedDropdownModule,TuiSvgModule,TuiDataListModule, TuiActiveZoneModule, TuiHostedDropdownModule,CommonModule
  ],
