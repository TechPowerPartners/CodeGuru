...
public static class CareerRoleExtensions
{
	...
	{
		return role is CareerRole.Amateur
			? CareerRole.AmateurPlus
			: role is CareerRole.AmateurPlus
			? CareerRole.Intern
			: role is CareerRole.Intern ? CareerRole.InternPlus : throw new ArgumentException("Роль нельзя забустить");
	}
